        ...
        @guest
            ...
            <li>
                <a href="{{ route('register') }}"
                    class="block text-center bg-blue-600 text-white font-semibold px-5 py-2 rounded-full hover:bg-blue-700 transition-colors duration-300">Register</a>
            </li>
        @endguest
